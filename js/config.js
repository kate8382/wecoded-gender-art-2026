...
export const zoomTimeline = {
  ...
  frontloadFactor: 0.65, // чтобы первые шаги были заметно быстрее, но не слишком резкими
  leadSeconds: 0.08, // сколько секунд до начала шагов зума, чтобы они начали прогрессировать (может быть 0 или даже отрицательным)
  leadFirstSeconds: 0.35, // сколько секунд проходит до начала первого шага зума начинать прогрессировать для первого шага (может быть 0 или даже отрицательным)
};

// Акцентный цвет, используемый для затемнения левой стороны (RGB)
export const accentColor = [255, 111, 168];
