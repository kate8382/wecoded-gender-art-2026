...
Кратко
--
Проект — небольшая фронтенд-инсталляция (HTML/CSS/JS) без сборщиков. Идея: музыкальная сцена с весами, на которые падают иконки (ноутбуки и мелкие предметы) в такт сцене; визуальные эффекты: постепенное затемнение, пульсация, масштабирование страницы, финал с конфетти.
